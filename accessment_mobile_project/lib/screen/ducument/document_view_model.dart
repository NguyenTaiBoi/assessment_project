                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text("[DC001][Container]Documents.pdf"),
                          Spacer(),
                          Icon(
                            Icons.delete,
                            color: Colors.red,
                      ...
                      GestureDetector(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text("[DC002][Container]Documents.pdf"),
                            Spacer(),
                            Icon(
                              Icons.delete,
                              color: Colors.red,
                      ...
                      Row(
                        children: [
                          ...
                          Text("[DC003][Container] Documents,pdf"),
                          Spacer(),
                          Icon(
                            Icons.delete,
                            color: Colors.red,
                      ...
                      Row(
                        children: [
                          ...
                          Text("[DC004][Container]Documents.pdf"),
                          Spacer(),
                          Icon(
                            Icons.delete,
                            color: Colors.red,
                      ...
                      Row(
                        children: [
                          ...
                          Text("[DC005][Container]Documents.pdf"),
                          Spacer(),
                          Icon(
                            Icons.delete,
                            color: Colors.red,
